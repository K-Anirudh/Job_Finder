...
public class signup_form extends javax.swing.JFrame {
     ...
     */
    ApplicantType a = new ApplicantType();
    public signup_form() {
        initComponents();
        setVisible(false);
    }
		...
		if(result.length() ==0){
        	...
        	//step1 load the driver class  
                        ...
                        Connection con=DriverManager.getConnection("jdbc:oracle:thin:@218.248.0.7:1521:RDBMS","it20737124","vasavi");  
                         String username_ = this.jTextField1.getText();
                         String password_ = this.jTextField2.getText();
                         ...
                         if(result=="Applicant")
                         {
                            ...
                            r2 = a.result;
                             ...
                             {
                                 userid = 5001;
                                 ResultSet rs = st.executeQuery("select count(*) from job_hoppers");
                               while(rs.next())
                                   userid+=rs.getInt(1);
                               System.out.println("userid = " +userid);
                    ...
                    //step4 execute query  
                     String query = " insert into users (user_id,user_name,password,state)"
                                  ...
                                  preparedStmt.setString (2,username_);
                                  preparedStmt.setString   (3,password_);
